...
if(isset($_POST['login'])){
    ...
    echo "<script>alert('Maaf, Pastikan Username dan Password anda benar!'); window.location=('index.php');</script>";}
        }
    }
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                  ...
                  <input type="text" name="username" class="form-control" id="input-ame" placeholder="Username atau email" required autofocus >
                </div>
                <div class="form-group">
                  <label for="recipient-name" class="col-form-label">Password</label>
                  <input type="password" name="password" class="form-control" id="input-ame" placeholder="Password" required autofocus >
                </div>
                <p>Belum punya akun? <a href="register.php">Daftar di sini</a></p>
                </div>
                <div class="modal-footer">
                  <button type="submit" name="login" value="Masuk" class="btn btn-info">Masuk ></button>
                </div>
              </form>
            </div>
